...
not that we should tabernacle here, but press forward for the mark.
...
but being indisposed with a head-ache, and meeting with many Friends, unsettled my mind.
